<?php
// source: C:\xampp2\htdocs\RTSoft\p1\app/config/config.neon 
// source: C:\xampp2\htdocs\RTSoft\p1\app/config/config.local.neon 

class Container_c72a1e124a extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\BaseModel' => [1 => ['27_App_Model_BaseModel']],
		...
		'services' => [
			...
			'27_App_Model_BaseModel' => 'App\Model\BaseModel',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp2\htdocs\RTSoft\p1\app',
			'wwwDir' => 'C:\xampp2\htdocs\RTSoft\p1\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp2\htdocs\RTSoft\p1\app/../temp',
		];
	}
	...
	public function createService__27_App_Model_BaseModel(): App\Model\BaseModel
	{
		$service = new App\Model\BaseModel($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('27_App_Model_BaseModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp2\htdocs\RTSoft\p1\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp2\htdocs\RTSoft\p1\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp2\htdocs\RTSoft\p1\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=projekt1', 'root',
			null, ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_c72a1e124a $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp2\htdocs\RTSoft\p1\app/../temp/cache/latte');
